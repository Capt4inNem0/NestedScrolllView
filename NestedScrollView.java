package com.tucarpinteria.app.ui;
...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3,
    ...
    private static final NestedScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE
            = new NestedScrollView.AccessibilityDelegate();
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overScrollByCompat(0, deltaY, 0, getScrollY(), 0, range, 0, mOverscrollDistance, true) && !hasNestedScrollingParent(ViewCompat.TYPE_TOUCH)) {
 ...
 //                   if (canOverscroll) {
    ...
    public void computeScroll() {
        ...
        if (unconsumed != 0) {
            // Internal Scroll
            final int oldScrollY = getScrollY();
            overScrollByCompat(0, unconsumed, getScrollX(), oldScrollY, 0, range, 0, mOverflingDistance, false);
...
//            if (canOverscroll) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mOverscrollDistance = h / 15; // TODO: Aca se cambia el largo del overscroll
        mOverflingDistance = h / 15;
...
//            fixed implementation:
            ...
            mScroller.fling(getScrollX(), getScrollY(), // start
                    ...
                    0, mOverflingDistance); // overscroll
    ...
    private void ensureGlows() {
        if (getOverScrollMode() != View.OVER_SCROLL_NEVER && useEdgeEffect) {
            if (mEdgeGlowTop == null) {
